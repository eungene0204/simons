 ...
 * 
 * 사용법:
 *   node scripts/import-stocks-from-excel.js /path/to/상장법인목록.xls
 */
 ...
 */
async function readStocksFromExcel(filePath) {
...
async function main() {
  try {
    ...
    if (!excelFilePath) {
      console.error('Usage: node scripts/import-stocks-from-excel.js <excel-file-path>');
      process.exit(1);
    }
...
module.exports = { main, readStocksFromExcel };
