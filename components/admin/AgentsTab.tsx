    ...
    flow: [
      ...
      },
      {
        ...
        items: [
          ...
          '미국 시장 제약 가드 — 미국 유니버스(S&P500·나스닥100·나스닥·다우·미국 전체·미국 ETF)는 정식 지원하되 한국 시장과의 혼합은 되묻기, 미국 지수는 한 전략에 하나만, 미국×업종 필터·미국×신규 상장·미국×AI 예측 신호(한국 데이터 학습 모델)는 명시적 미지원 안내와 함께 해당 조건만 제거한다 — 엔진 US 분기의 거절과 같은 계약을 컴파일 전에 먼저 안내(조용한 제거 금지). 미국 ETF(US_ETF)의 기업 재무지표 금지는 국내 ETF와 같은 검증을 공유 (2026-08-25 US 레인 Phase 2)',
