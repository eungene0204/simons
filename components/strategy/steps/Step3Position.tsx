          ...
          <div className="bg-[#0f0f0f] rounded-3xl border border-gray-800/50 p-5 shadow-xl flex flex-col space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3 bg-[#1a1a1a]/40 p-5 rounded-2xl border border-gray-800/40 backdrop-blur-sm flex-1">
              ...
              >
                ...
                <div>
                  <div className={`text-sm font-black mb-1 ${executionTiming === "next_open" ? "text-white" : "text-[#a0a0a0]"}`}>익일 시가 (Next Open)</div>
              ...
              >
                ...
                <div>
                  <div className={`text-sm font-black mb-1 ${executionTiming === "current_close" ? "text-white" : "text-[#a0a0a0]"}`}>당일 종가 (Direct Close)</div>
