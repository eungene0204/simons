...
const BUSINESS_INFO_LINE_2 =
  "주소 : 서울특별시 서대문구 이화여대7길 37, 3층 S88호   이메일 : nullspace.support@gmail.com";
...
export const EXAMPLES: Example[] = [
  ...
  },
  {
    ...
    prompt: "복잡한 지표는 아직 어려워서 최근 고점을 넘는 종목만 단순하게 따라가고 싶어요. KOSPI 종목 중 20일 고점을 넘기는 날 매수하고 20일 저가 아래로 내려오면 매도해 주세요. 최대 8종목, 손절은 -7%로 부탁드립니다.",
  },
  {
    level: "beginner",
    category: "모멘텀",
    title: "60일 수익률 상위 조건",
    prompt: "KOSDAQ에서 최근 60거래일 수익률이 높은 종목 상위권만 골라서 6종목 정도 나눠 사고, 한 달에 한 번씩 다시 순위를 확인해 주세요. 손절은 -9%로 해주세요.",
  },
  {
    level: "beginner",
    category: "복합전략",
  ...
  },
  {
    level: "beginner",
    category: "가치투자",
    title: "저PER 빚 적은 기업 고르기",
    prompt: "싼 종목 중에서도 빚이 적은 회사를 골라서 비교적 편하게 보유하고 싶습니다. KOSPI 종목 중 PER이 낮고 부채비율이 낮은 기업만 남긴 뒤 8종목 정도 동일하게 투자해 주세요. 너무 큰 손실만 막고 싶어서 손절은 -10%, 점검은 두 달에 한 번이면 좋겠습니다.",
  },
  {
    level: "beginner",
    category: "기술분석",
  ...
  },
  {
    ...
    prompt: "KOSPI에서 시가총액 3000억 원 이상 2조 원 이하 중형주만 대상으로 PBR 1.2배 이하, ROE 10% 이상이고 최근 4개 분기 영업활동현금흐름 증가율이 10% 이상인 기업을 선별해 주세요. 거래대금은 50억 원 이상으로 제한하고 10종목 집중 포트폴리오를 구성하되 분기 리밸런싱, 손절 -11%, 익절 +20%를 적용해 주세요.",
  },
  {
    level: "expert",
    category: "모멘텀",
