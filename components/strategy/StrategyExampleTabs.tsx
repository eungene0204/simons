...
const EXAMPLES: Example[] = [
  ...
  },
  {
    level: "intermediate",
    category: "가치투자",
    title: "퀄리티 밸류 분기 리밸런싱",
    prompt: "KOSPI 200 안에서 ROE 12% 이상, 부채비율 120% 이하, PER 12배 이하 조건을 동시에 만족하는 종목으로 포트폴리오를 만들고 싶습니다. 재무적으로 버틸 체력이 있으면서도 너무 비싸지 않은 기업 위주로 15종목 정도 담고, 분기마다 조건을 다시 점검해서 리밸런싱해 주세요. 손절은 -15%로 설정해 주세요.",
  },
  {
    level: "intermediate",
    category: "기술분석",
