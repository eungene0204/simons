...
export default function VirtualAccountCard({ account }: VirtualAccountCardProps) {
  ...
  return (
    <div
      ...
      className="bg-gray-800 rounded-lg shadow-sm border border-gray-700 p-4 cursor-pointer hover:shadow-md transition-shadow hover:border-blue-500"
    >
      <div className="flex flex-col h-full">
        ...
        {/* 총 자산 */}
        <div className="mb-3">
          <p className="text-xs text-gray-400 mb-1">{t("총 자산")}</p>
        ...
        {/* 초기 모의 투자금액 */}
        <div className="mb-3">
          <p className="text-xs text-gray-400 mb-1">{t("초기 모의 투자금액")}</p>
        ...
        {/* 손익 */}
        <div className="mb-3">
          <p className="text-xs text-gray-400 mb-1">{t("손익")}</p>
        ...
        <div className="mt-auto pt-3 border-t border-gray-700">
          <p className="text-xs text-gray-400 mb-1">{t("현재 잔액")}</p>
