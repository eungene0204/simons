...
const sections = [
  ...
  },
  {
    ...
    list: [
      ...
      "답변 품질 점검을 위해 기록하는 AI 대화 내용(질문과 답변)은 90일이 지나면 자동으로 파기합니다. 이메일 인증번호 기록은 유효기간이 지난 다음 날, 결제 웹훅 수신 기록은 180일, 관리자 작업 기록은 3년이 지나면 파기합니다.",
  ...
  },
  {
    ...
    table: [
      ...
      },
      {
        label: "이용 통계 분석",
        content:
          "Google LLC(미국) — Google Analytics를 통한 서비스 이용 통계 분석을 위해 쿠키 식별자, 방문 페이지, 접속 일시, 브라우저·기기 정보를 처리",
      },
    ],
    list: [
  ...
  },
  {
    ...
    list: [
      ...
      "회사는 서비스 이용 통계 분석을 위해 Google LLC의 웹로그 분석 도구인 Google Analytics를 사용합니다. Google Analytics는 쿠키를 통해 방문 페이지, 접속 일시, 브라우저·기기 정보 등 서비스 이용 기록을 수집하며, 회사는 이 과정에서 이용자를 직접 식별하는 정보를 Google Analytics에 전달하지 않습니다. 수집된 정보는 Google이 미국 등 국외 서버에서 처리할 수 있습니다.",
      "이용자는 브라우저의 쿠키 차단 설정 또는 Google Analytics 차단 브라우저 부가기능(tools.google.com/dlpage/gaoptout)을 통해 Google Analytics의 수집을 거부할 수 있으며, 거부하더라도 서비스 이용에는 제한이 없습니다.",
    ],
  },
  {
