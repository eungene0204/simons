...
_FIELD_LABELS: Dict[str, str] = {
    ...
    "max_sector_weight_pct": "섹터별 비중 상한",
    "ranking_entry_delay_days": "실적 발표 후 편입 지연",
    "ranking_expiry_days": "실적 발표 후 제외 기간",
    "universe_market_cap_top_n": "시가총액 상위 종목 수",
    "exclude_sectors": "제외 업종",
    "seasonal_months": "투자하는 달(계절 필터)",
    "volatility_target": "목표 변동성",
    "market_regime": "시장 국면 필터",
    "universe_liquidity_exclude_bottom_pct": "거래대금 하위 제외 비율",
    "universe_market_cap_exclude_bottom_pct": "시가총액 하위 제외 비율",
    "universe_exclude_loss_making": "적자기업 제외 기준",
    "universe_liquidity_lookback_days": "거래대금 산정 기간",
