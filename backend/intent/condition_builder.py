...
_PATTERNS: dict[str, "re.Pattern[str]"] = {
    ...
    "eps_growth": _c(r"eps\s*증가율|eps\s*성장|eps\s*growth"),
    "ebitda_growth": _c(r"ebitda\s*증가율|ebitda\s*성장|ebitda\s*growth"),
    "ocf_growth": _c(r"영업\s*(?:활동)?\s*현금\s*흐름\s*증가율|영업\s*(?:활동)?\s*현금\s*흐름\s*성장|ocf\s*growth"),
    "fcf_growth": _c(r"fcf\s*증가율|fcf\s*성장|잉여\s*현금\s*흐름\s*증가율|잉여\s*현금\s*흐름\s*성장|fcf\s*growth"),
