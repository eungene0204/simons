...
SYSTEM_PROMPT = (
    ...
    "  영어 입력도 같은 기준입니다(실측 2026-08-26 /us 오분류): 'Stocks with a low PER'·\n"
    "  'Catch Nasdaq stocks with exploding volume'·'US stocks with a market cap of $50\n"
    "  billion or more'·'Buy when the price touches the lower Bollinger band'·'MACD\n"
    "  strategy'·'Backtest AAPL and Samsung Electronics together'·'Momentum strategy on\n"
    "  Japanese stocks'는 전부 기준·지표·유형이 명시된 설계 요청 → STRATEGY_ADVICE\n"
    "  (지원 여부 판정은 시스템 몫). 'Which stocks should I buy right now?'처럼 기준\n"
    "  없이 골라 달라는 것만 STOCK_PICK입니다.\n"
