  ...
  async run(strategy: StrategyDSL, options: BacktestConfigOptions): Promise<BacktestResult> {
    ...
    try {
      ...
      return {
        ...
        beta: pythonResult.beta ?? null,
        alpha: pythonResult.alpha ?? null,
        trackingError: pythonResult.trackingError ?? null,
        informationRatio: pythonResult.informationRatio ?? null,
        avgHoldingDays: Number(pythonResult.avgHoldingDays || 0),
        exposure: Number(pythonResult.exposure || 0),
        maxDrawdownDuration: Number(pythonResult.maxDrawdownDuration || 0),
        expectancy: Number(pythonResult.expectancy || 0),
        recoveryFactor: Number(pythonResult.recoveryFactor || 0),
        ...
        benchmarkPartial: pythonResult.benchmark_partial,
        ...
        factorIc: pythonResult.factorIc ?? undefined,
        analytics: pythonResult.analytics ?? undefined,
        turnover: pythonResult.turnover ?? undefined,
